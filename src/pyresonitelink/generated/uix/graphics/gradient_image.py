...
class GradientImage(GeneratedComponent, IUIComputeComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.UIX.GradientImage.
    ...
    def __init__(self, sprite: str | IAssetProvider[Sprite] | None = None, material: str | IAssetProvider[Material] | None = None, preserve_aspect: primitives.Bool | None = None, flip_horizontally: primitives.Bool | None = None, flip_vertically: primitives.Bool | None = None, interaction_target: primitives.Bool | None = None, fill_rect: primitives.Rect | None = None, legacy_zwrite: primitives.Bool | None = None, tint_top_left: primitives.ColorX | None = None, tint_top_right: primitives.ColorX | None = None, tint_bottom_right: primitives.ColorX | None = None, tint_bottom_left: primitives.ColorX | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def tint_bottom_right(self) -> primitives.ColorX | None:
        """The TintBottomRight field value."""
    ...
    def tint_bottom_left(self) -> primitives.ColorX | None:
        """The TintBottomLeft field value."""
