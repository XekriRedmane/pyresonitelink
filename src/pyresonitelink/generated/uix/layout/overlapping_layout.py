...
class OverlappingLayout(GeneratedComponent, ILayoutElement, IUIComputeComponent, IWorldEventReceiver):
    ...
    def __init__(self, padding_top: np.float32 | None = None, padding_right: np.float32 | None = None, padding_bottom: np.float32 | None = None, padding_left: np.float32 | None = None, force_expand_width: bool | None = None, force_expand_height: bool | None = None, *, component: workers.Component | None = None) -> None:
