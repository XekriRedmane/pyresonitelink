...
class VerticalLayout(GeneratedComponent, ILayoutElement, IUIComputeComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.UIX.VerticalLayout.
    ...
    def __init__(self, padding_top: np.float32 | None = None, padding_right: np.float32 | None = None, padding_bottom: np.float32 | None = None, padding_left: np.float32 | None = None, spacing: np.float32 | None = None, force_expand_width: bool | None = None, force_expand_height: bool | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def force_expand_width(self) -> bool | None:
    ...
    def force_expand_width(self, value: bool) -> None:
    ...
    @property
    def force_expand_height(self) -> bool | None:
    ...
    def force_expand_height(self, value: bool) -> None:
