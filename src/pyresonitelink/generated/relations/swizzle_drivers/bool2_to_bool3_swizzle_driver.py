"""Generated component: Bool2ToBool3SwizzleDriver."""
...
class Bool2ToBool3SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Bool2ToBool3SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Bool2ToBool3SwizzleDriver"

    def __init__(self, source: str | IField[primitives.Bool2] | None = None, target: str | IField[primitives.Bool3] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
