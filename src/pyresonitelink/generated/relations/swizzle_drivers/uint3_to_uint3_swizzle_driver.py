"""Generated component: Uint3ToUint3SwizzleDriver."""
...
class Uint3ToUint3SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Uint3ToUint3SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Uint3ToUint3SwizzleDriver"

    def __init__(self, source: str | IField[primitives.UInt3] | None = None, target: str | IField[primitives.UInt3] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
