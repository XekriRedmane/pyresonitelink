...
class Bool4ToBool3SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """The Bool 4To Bool 3Swizzle Driver component.
    ...
    def __init__(self, source: str | IField[primitives.Bool4] | None = None, target: str | IField[primitives.Bool3] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
