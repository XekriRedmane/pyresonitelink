"""Generated component: Bool4ToBool4SwizzleDriver."""
...
class Bool4ToBool4SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Bool4ToBool4SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Bool4ToBool4SwizzleDriver"

    def __init__(self, source: str | IField[primitives.Bool4] | None = None, target: str | IField[primitives.Bool4] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, w: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
