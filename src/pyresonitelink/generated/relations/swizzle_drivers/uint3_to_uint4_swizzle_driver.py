...
class Uint3ToUint4SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Uint3ToUint4SwizzleDriver.
    ...
    def __init__(self, source: str | IField[primitives.UInt3] | None = None, target: str | IField[primitives.UInt4] | None = None, x: np.int32 | None = None, y: np.int32 | None = None, z: np.int32 | None = None, w: np.int32 | None = None, *, component: workers.Component | None = None) -> None:
