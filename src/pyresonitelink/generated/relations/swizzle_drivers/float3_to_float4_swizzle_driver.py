...
class Float3ToFloat4SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, source: str | IField[primitives.Float3] | None = None, target: str | IField[primitives.Float4] | None = None, x: np.int32 | None = None, y: np.int32 | None = None, z: np.int32 | None = None, w: np.int32 | None = None, *, component: workers.Component | None = None) -> None:
