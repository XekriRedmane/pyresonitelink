"""Generated component: Float2ToFloatQSwizzleDriver."""
...
class Float2ToFloatQSwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Float2ToFloatQSwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float2ToFloatQSwizzleDriver"

    def __init__(self, source: str | IField[primitives.Float2] | None = None, target: str | IField[primitives.FloatQ] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, w: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def target(self, target: str | IField[primitives.FloatQ] | None) -> None:
        """Set the Target reference by target ID or IField[primitives.FloatQ] instance."""
        target_id: str | None = target.id if isinstance(target, IField) else target  # type: ignore[assignment]
        member = self.get_member("Target")
        if isinstance(member, members.Reference):
            member.targetId = target_id
