"""Generated component: Float4ToColorXSwizzleDriver."""
...
class Float4ToColorXSwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Float4ToColorXSwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float4ToColorXSwizzleDriver"

    def __init__(self, source: str | IField[primitives.Float4] | None = None, target: str | IField[primitives.ColorX] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, w: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
