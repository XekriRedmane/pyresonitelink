"""Generated component: Int3ToInt3SwizzleDriver."""
...
class Int3ToInt3SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Int3ToInt3SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Int3ToInt3SwizzleDriver"

    def __init__(self, source: str | IField[primitives.Int3] | None = None, target: str | IField[primitives.Int3] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
