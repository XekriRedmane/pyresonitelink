"""Generated component: Float2ToFloat3SwizzleDriver."""
...
class Float2ToFloat3SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Float2ToFloat3SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float2ToFloat3SwizzleDriver"

    def __init__(self, source: str | IField[primitives.Float2] | None = None, target: str | IField[primitives.Float3] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
