"""Generated component: Float3ToColorXSwizzleDriver."""
...
class Float3ToColorXSwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float3ToColorXSwizzleDriver"

    def __init__(self, source: str | IField[primitives.Float3] | None = None, target: str | IField[primitives.ColorX] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, w: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
