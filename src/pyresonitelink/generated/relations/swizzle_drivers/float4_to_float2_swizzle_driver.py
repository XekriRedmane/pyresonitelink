...
class Float4ToFloat2SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, source: str | IField[primitives.Float4] | None = None, target: str | IField[primitives.Float2] | None = None, x: np.int32 | None = None, y: np.int32 | None = None, *, component: workers.Component | None = None) -> None:
