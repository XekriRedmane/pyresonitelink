"""Generated component: Float4ToFloat2SwizzleDriver."""
...
class Float4ToFloat2SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Float4ToFloat2SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float4ToFloat2SwizzleDriver"

    def __init__(self, source: str | IField[primitives.Float4] | None = None, target: str | IField[primitives.Float2] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
