...
class Int3ToInt2SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Int3ToInt2SwizzleDriver.
    ...
    def __init__(self, source: str | IField[primitives.Int3] | None = None, target: str | IField[primitives.Int2] | None = None, x: np.int32 | None = None, y: np.int32 | None = None, *, component: workers.Component | None = None) -> None:
