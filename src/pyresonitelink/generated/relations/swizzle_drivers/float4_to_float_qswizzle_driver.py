"""Generated component: Float4ToFloatQSwizzleDriver."""
...
class Float4ToFloatQSwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Float4ToFloatQSwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float4ToFloatQSwizzleDriver"

    def __init__(self, source: str | IField[primitives.Float4] | None = None, target: str | IField[primitives.FloatQ] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, w: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
