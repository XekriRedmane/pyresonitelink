"""Generated component: Uint4ToUint4SwizzleDriver."""
...
class Uint4ToUint4SwizzleDriver(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Uint4ToUint4SwizzleDriver.

    Category: Relations/Swizzle Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Uint4ToUint4SwizzleDriver"

    def __init__(self, source: str | IField[primitives.UInt4] | None = None, target: str | IField[primitives.UInt4] | None = None, x: primitives.Int | None = None, y: primitives.Int | None = None, z: primitives.Int | None = None, w: primitives.Int | None = None, *, component: workers.Component | None = None) -> None:
