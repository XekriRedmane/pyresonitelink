"""Generated component: UniformSizeRangeInitializer."""
...
class UniformSizeRangeInitializer(GeneratedComponent, IParticleSystemModule, IWorldEventReceiver):
    """The UniformSizeRangeInitializer component makes particles in a particle system have a random size in a range.
...
This component is part of the Photon Dust system made by Frooxius.
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.PhotonDust.UniformSizeRangeInitializer"
    ...
    def min_value(self) -> primitives.Float | None:
        """The minimum size particles can be on all 3 axies equally."""
    ...
    def max_value(self) -> primitives.Float | None:
        """The maximum size particles can be on all 3 axies equally."""
