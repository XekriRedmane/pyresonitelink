...
class LegacyGlowCircle(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    Doesn't need to be used by the user. Is auto generated by spawn points
    when they make their visual.
    """
    ...
    def radius(self) -> primitives.Float | None:
        """The radius of the circle visual."""
    ...
    def height(self) -> primitives.Float | None:
        """The height of the walls for the glow visual."""
    ...
    def cylinder_offset(self) -> str | None:
        """The field to drive with the offset of the cylinder used for this visual."""
    ...
    def cylinder_radius(self) -> str | None:
        """The field to drive with the radius of the cylinder used for this visual."""
    ...
    def cylinder_height(self) -> str | None:
        """The field to drive with the height of the cylinder used for this visual."""
    ...
    def circle_quad_size(self) -> str | None:
        """The field to drive with the size of the cylinder faces used for this visual."""
    ...
    def circle_tint(self) -> str | None:
        """The field to drive with the color of the circle used for this visual."""
    ...
    def cylinder_tint(self) -> str | None:
        """The field to drive with the color of the cylinder used for this visual."""
