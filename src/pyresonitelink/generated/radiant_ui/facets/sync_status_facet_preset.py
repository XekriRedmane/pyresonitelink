"""Generated component: SyncStatusFacetPreset."""
...
class SyncStatusFacetPreset(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.SyncStatusFacetPreset.

    Category: Radiant UI/Facets
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.SyncStatusFacetPreset"
