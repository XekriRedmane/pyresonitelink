"""Generated component: NameplateVisibilityFacetPreset."""
...
class NameplateVisibilityFacetPreset(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.NameplateVisibilityFacetPreset.

    Category: Radiant UI/Facets
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.NameplateVisibilityFacetPreset"
