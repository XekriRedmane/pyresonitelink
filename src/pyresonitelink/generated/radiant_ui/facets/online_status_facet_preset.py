"""Generated component: OnlineStatusFacetPreset."""
...
class OnlineStatusFacetPreset(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.OnlineStatusFacetPreset.

    Category: Radiant UI/Facets
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.OnlineStatusFacetPreset"
