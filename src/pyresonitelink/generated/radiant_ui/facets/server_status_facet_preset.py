"""Generated component: ServerStatusFacetPreset."""
...
class ServerStatusFacetPreset(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.ServerStatusFacetPreset.

    Category: Radiant UI/Facets
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.ServerStatusFacetPreset"
