"""Generated component: SeatedModeFacetPreset."""
...
class SeatedModeFacetPreset(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.SeatedModeFacetPreset.

    Category: Radiant UI/Facets
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.SeatedModeFacetPreset"
