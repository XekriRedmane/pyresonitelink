"""Generated component: FeedEntityInterface."""
...
class FeedEntityInterface(GenericComponent[T], IComponent, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        FeedEntityInterface[primitives.Float]
        FeedEntityInterface[primitives.Float3]
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.FeedEntityInterface<>"
    _GENERIC_TYPE_TEMPLATE = "[FrooxEngine]FrooxEngine.FeedEntityInterface<>"

    def __init__(self, has_data: primitives.Bool | None = None, item_name: str | IField[primitives.String] | None = None, item_key: str | IField[primitives.String] | None = None, item_description: str | IField[primitives.String] | None = None, has_description: str | IField[primitives.Bool] | None = None, description_cleanup: str | Slot | None = None, item_icon: str | IField[str] | None = None, has_icon: str | IField[primitives.Bool] | None = None, icon_cleanup: str | Slot | None = None, view: str | SyncRef[IDataFeedView] | None = None, parent_container: str | FeedItemInterface | None = None, child_container: str | Slot | None = None, enabled_state: str | IField[primitives.Bool] | None = None, reference: str | SyncRef[E] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @reference.setter
    def reference(self, target: str | SyncRef[E] | None) -> None:
        """Set the Reference reference by target ID or SyncRef[E] instance."""
        target_id: str | None = target.id if isinstance(target, SyncRef) else target  # type: ignore[assignment]
        member = self.get_member("Reference")
        if isinstance(member, members.Reference):
            member.targetId = target_id
            ...
            self.set_member(
                "Reference",
                members.Reference(targetId=target_id, targetType='[FrooxEngine]FrooxEngine.SyncRef<E>'),
            )
