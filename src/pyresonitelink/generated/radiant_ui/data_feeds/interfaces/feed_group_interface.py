"""Generated component: FeedGroupInterface."""
...
class FeedGroupInterface(GeneratedComponent, IComponent, IWorldEventReceiver):
    """The FeedGroupInterface component is used as a template type item in data feed mappers in the Data Feeds system.

    Category: Radiant UI/Data Feeds/Interfaces
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.FeedGroupInterface"

    def __init__(self, has_data: primitives.Bool | None = None, item_name: str | IField[primitives.String] | None = None, item_key: str | IField[primitives.String] | None = None, item_description: str | IField[primitives.String] | None = None, has_description: str | IField[primitives.Bool] | None = None, description_cleanup: str | Slot | None = None, item_icon: str | IField[str] | None = None, has_icon: str | IField[primitives.Bool] | None = None, icon_cleanup: str | Slot | None = None, view: str | SyncRef[IDataFeedView] | None = None, parent_container: str | FeedItemInterface | None = None, child_container: str | Slot | None = None, enabled_state: str | IField[primitives.Bool] | None = None, *, component: workers.Component | None = None) -> None:
