"""Generated component: FeedSliderInterface."""
...
class FeedSliderInterface(GenericComponent[T], IComponent, IWorldEventReceiver):
    ...
    def __init__(self, has_data: primitives.Bool | None = None, item_name: str | IField[primitives.String] | None = None, item_key: str | IField[primitives.String] | None = None, item_description: str | IField[primitives.String] | None = None, has_description: str | IField[primitives.Bool] | None = None, description_cleanup: str | Slot | None = None, item_icon: str | IField[str] | None = None, has_icon: str | IField[primitives.Bool] | None = None, icon_cleanup: str | Slot | None = None, view: str | SyncRef[IDataFeedView] | None = None, parent_container: str | FeedItemInterface | None = None, child_container: str | Slot | None = None, enabled_state: str | IField[primitives.Bool] | None = None, value: str | IField[T] | None = None, formatting: str | IField[primitives.String] | None = None, min: str | IField[T] | None = None, max: str | IField[T] | None = None, reference_value: str | IField[T] | None = None, reference_value_cleanup_root: str | Slot | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            reference_value: Initial value for ReferenceValue.
            reference_value_cleanup_root: Initial value for ReferenceValueCleanupRoot.
        ...
        if reference_value_cleanup_root is not None:
            self.reference_value_cleanup_root = reference_value_cleanup_root
    ...
    def reference_value(self, target: str | IField[T] | None) -> None:
        """Set the ReferenceValue reference by target ID or IField[T] instance."""
        target_id: str | None = target.id if isinstance(target, IField) else target  # type: ignore[assignment]
        member = self.get_member("ReferenceValue")
        if isinstance(member, members.Reference):
            member.targetId = target_id
    ...
    @reference_value_cleanup_root.setter
    def reference_value_cleanup_root(self, target: str | Slot | None) -> None:
        """Set the ReferenceValueCleanupRoot reference by target ID or Slot instance."""
        target_id: str | None = target.id if isinstance(target, Slot) else target  # type: ignore[assignment]
        member = self.get_member("ReferenceValueCleanupRoot")
        if isinstance(member, members.Reference):
            member.targetId = target_id
