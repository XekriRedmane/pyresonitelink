...
class FeedSliderInterface(GenericComponent[T], IComponent, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        FeedSliderInterface[np.float32]
