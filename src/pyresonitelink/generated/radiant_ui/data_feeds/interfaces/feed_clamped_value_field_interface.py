...
class FeedClampedValueFieldInterface(GenericComponent[T], IComponent, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        FeedClampedValueFieldInterface[np.float32]
