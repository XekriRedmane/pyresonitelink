"""Generated component: FeedValueActionInterface."""
...
class FeedValueActionInterface(GenericComponent[T], IComponent, IWorldEventReceiver):
    ...
    @action.setter
    def action(self, target: str | SyncDelegate[Action[T]] | None) -> None:
        """Set the Action reference by target ID or SyncDelegate[Action[T]] instance."""
        ...
        if isinstance(member, members.Reference):
            ...
            self.set_member(
                "Action",
                members.Reference(targetId=target_id, targetType='[FrooxEngine]FrooxEngine.SyncDelegate<Action<T>>'),
            )
