"""Generated component: FieldHookBase+Proxy."""
...
class FieldHookBase+Proxy(GenericComponent[T], IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.ProtoFlux.CoreNodes.FieldHookBase<>+Proxy.
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.ProtoFlux.CoreNodes.FieldHookBase<>+Proxy"
    _GENERIC_TYPE_TEMPLATE = "[FrooxEngine]FrooxEngine.ProtoFlux.CoreNodes.FieldHookBase<>+Proxy"
