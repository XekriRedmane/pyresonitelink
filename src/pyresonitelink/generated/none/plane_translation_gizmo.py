...
class PlaneTranslationGizmo(GeneratedComponent, IMaterialApplyPolicy, IWorldEventReceiver):
    ...
    def auto_position_at_target_slot(self) -> primitives.Bool | None:
        """Whether to auto position this gizmo at the specified slot."""
    ...
    def interacting_component(self) -> str | None:
        """the component That is interacting with this."""
    ...
    def material(self) -> str | None:
        """The material being used to show this gizmo."""
    ...
    def tool_point(self) -> str | None:
        """The tool tip that is controlling this gizmo."""
    ...
    def active_point(self) -> str | None:
        """The point for this gizmo when using tip instead of projection for the interacting tooltip."""
    ...
    def line_root(self) -> str | None:
        """The root slot of the visual being used when doing tip instead of Projection for the interacting tooltip."""
    ...
    def line_segment(self) -> str | None:
        """The mesh being used for the line visual."""
    ...
    def snap_highlight(self) -> str | None:
        """The root of the snap highlight visual sphere."""
    ...
    def point_space(self) -> members.SyncObject | None:
        """The transform space of the field this is modifying."""
    ...
    def point_space(self, value: members.SyncObject) -> None:
        """Set PointSpace. The transform space of the field this is modifying."""
        self.set_member("PointSpace", value)

    @property
    def target_point(self) -> str | None:
        """The field this is targeting."""
    ...
    def normal(self) -> primitives.Float3 | None:
        """The normal of where this plane gizmo should be pointing for its normal."""
    ...
    def normal_space(self) -> members.SyncObject | None:
        """The transform space the normal is defined in."""
    ...
    def normal_space(self, value: members.SyncObject) -> None:
        """Set NormalSpace. The transform space the normal is defined in."""
        self.set_member("NormalSpace", value)

    @property
    def use_custom_visual(self) -> primitives.Bool | None:
        """Whether to use a custom visual for this gizmo."""
    ...
    def handle_size(self) -> primitives.Float2 | None:
        """The size of the plane used for interacting with this component."""
    ...
    def handle_offset(self) -> primitives.Float2 | None:
        """The offset of the plane used for interacting with this component."""
    ...
    def create_undo_steps(self) -> primitives.Bool | None:
        """Whether to create Undo steps for interacting with this gizmo."""
    ...
    def visual_root(self) -> str | None:
        """The root slot of the visual of this gizmo."""
    ...
    def visual_rotation(self) -> str | None:
        """The rotation field of this Gizmos visual."""
    ...
    def visual_position(self) -> str | None:
        """The position field of this gizmo's visual."""
    ...
    def box_size(self) -> str | None:
        """The size of the box mesh being used for this visual."""
    ...
    def lines_root(self) -> str | None:
        """The root slot for the tip projection lines visual."""
    ...
    def line0(self) -> str | None:
        """The first line for this gizmo when interacting via tip instead of Projection with a dev tip."""
    ...
    def line1(self) -> str | None:
        """The second line for this gizmo when interacting via tip instead of Projection with a dev tip."""
    ...
    def collider(self) -> str | None:
        """The collider for interacting with this gizmo."""
