...
class GeneralHapticsSettings(GeneratedComponent, ICustomInspector):
    ...
    def __init__(self, enable_controller_vibration: bool | None = None, enable_haptics: bool | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def enable_controller_vibration(self) -> bool | None:
    ...
    def enable_controller_vibration(self, value: bool) -> None:
    ...
    @property
    def enable_haptics(self) -> bool | None:
    ...
    def enable_haptics(self, value: bool) -> None:
