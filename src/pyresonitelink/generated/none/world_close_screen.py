"""Generated component: WorldCloseScreen."""
...
from pyresonitelink.generated._types.world_close_dialog import WorldCloseDialog
...
class WorldCloseScreen(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, icon: str | None = None, active_color: primitives.ColorX | None = None, label: primitives.String | None = None, screen_enabled: primitives.Bool | None = None, base_resolution: primitives.Float2 | None = None, screen_root: str | Slot | None = None, screen_canvas: str | Canvas | None = None, modal_overlay_manager: str | ModalOverlayManager | None = None, button: str | RadiantDashButton | None = None, icon_texture: str | IAssetProvider[Texture2D] | None = None, close_dialog: str | WorldCloseDialog | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            close_dialog: Initial value for _closeDialog.
    ...
    @close_dialog.setter
    def close_dialog(self, target: str | WorldCloseDialog | None) -> None:
        """Set the _closeDialog reference by target ID or WorldCloseDialog instance."""
        target_id: str | None = target.id if isinstance(target, WorldCloseDialog) else target  # type: ignore[assignment]
        member = self.get_member("_closeDialog")
        if isinstance(member, members.Reference):
            member.targetId = target_id
        else:
            self.set_member(
                "_closeDialog",
                members.Reference(targetId=target_id, targetType='[FrooxEngine]FrooxEngine.WorldCloseDialog'),
            )
