"""Generated component: AsyncDynamicImpulseReceiverWithValue+Proxy."""
...
class AsyncDynamicImpulseReceiverWithValue+Proxy(GenericComponent[T], IComponent, IWorldEventReceiver):
    """Wrapper for [ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseReceiverWithValue<>+Proxy.

    Parameterize with a value type::

        AsyncDynamicImpulseReceiverWithValue+Proxy[primitives.Float]
        AsyncDynamicImpulseReceiverWithValue+Proxy[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseReceiverWithValue<>+Proxy"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseReceiverWithValue<>+Proxy"
