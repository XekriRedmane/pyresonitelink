...
class ProtoFluxElementProxy(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, node: str | ProtoFluxNode | None = None, element_name: str | None = None, is_dynamic: bool | None = None, index: np.int32 | None = None, connect_point: str | Slot | None = None, *, component: workers.Component | None = None) -> None:
