...
class LegacyLightsModuleAdapter(GeneratedComponent, IComponent, IWorldEventReceiver):
    """The LegacyLightsModuleAdapter component is used in converted legacy particle systems that were converted to PhotonDust as part of The Performance Updates.
    ...
    def reference_light(self) -> str | None:
        """The light to use as a target for converted values."""
    ...
    def lights_module_enabled(self) -> str | None:
        """The field to drive with whether the lights module is enabled."""
