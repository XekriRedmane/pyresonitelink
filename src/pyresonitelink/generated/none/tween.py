...
class Tween(GenericComponent[T], IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Tween<>.
    ...
    def only_under_parent(self) -> str | None:
        """Target ID of the OnlyUnderParent reference (targets Slot)."""
    ...
    @property
    def curve(self) -> members.FieldEnum | None:
        """The Curve member."""
    ...
    @curve.setter
    def curve(self, value: members.FieldEnum) -> None:
        """Set the Curve member."""
