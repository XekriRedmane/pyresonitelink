...
class ConvertibleCharDriver(GenericComponent[T], IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.ConvertibleCharDriver<>.
    ...
    def target(self, target: str | IField[primitives.Char] | None) -> None:
        ...
        if isinstance(member, members.Reference):
            ...
            self.set_member(
                "Target",
                members.Reference(targetId=target_id, targetType='[FrooxEngine]FrooxEngine.IField<char>'),
            )
