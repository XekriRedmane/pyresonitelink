...
class ConvertibleIntDriver(GenericComponent[T], IComponent, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        ConvertibleIntDriver[np.float32]
    ...
    def __init__(self, source: str | IField[T] | None = None, target: str | IField[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
