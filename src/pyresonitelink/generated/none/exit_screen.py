"""Generated component: ExitScreen."""
...
class ExitScreen(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, icon: str | None = None, active_color: primitives.ColorX | None = None, label: str | None = None, screen_enabled: bool | None = None, base_resolution: primitives.Float2 | None = None, screen_root: str | Slot | None = None, screen_canvas: str | Canvas | None = None, modal_overlay_manager: str | ModalOverlayManager | None = None, button: str | RadiantDashButton | None = None, icon_texture: str | IAssetProvider[Texture2D] | None = None, sponsor_name: str | None = None, sponsor_icon: str | StaticTexture2D | None = None, shoutouts: str | Text | None = None, exit_message: str | Text | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            sponsor_name: Initial value for _sponsorName.
            sponsor_icon: Initial value for _sponsorIcon.
            shoutouts: Initial value for _shoutouts.
            exit_message: Initial value for _exitMessage.
        ...
        if sponsor_icon is not None:
            self.sponsor_icon = sponsor_icon
        if shoutouts is not None:
    ...
    @property
    def sponsor_name(self) -> str | None:
    ...
    @sponsor_name.setter
    def sponsor_name(self, value: str) -> None:
        """Set the _sponsorName field value."""
        member = self.get_member("_sponsorName")
        if member is not None:
            member.value = value  # type: ignore[attr-defined]
        else:
            self.set_member(
                "_sponsorName", fields.FieldString(value=value)
            )
    ...
    @sponsor_icon.setter
    def sponsor_icon(self, target: str | StaticTexture2D | None) -> None:
        """Set the _sponsorIcon reference by target ID or StaticTexture2D instance."""
    ...
    @shoutouts.setter
    def shoutouts(self, target: str | Text | None) -> None:
        """Set the _shoutouts reference by target ID or Text instance."""
    ...
    @exit_message.setter
    def exit_message(self, target: str | Text | None) -> None:
        """Set the _exitMessage reference by target ID or Text instance."""
        target_id: str | None = target.id if isinstance(target, Text) else target  # type: ignore[assignment]
        member = self.get_member("_exitMessage")
        if isinstance(member, members.Reference):
            member.targetId = target_id
