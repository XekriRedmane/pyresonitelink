...
class ProtoFluxInputProxy(GeneratedComponent):
    ...
    def __init__(self, node: str | ProtoFluxNode | None = None, element_name: primitives.String | None = None, is_dynamic: primitives.Bool | None = None, index_: primitives.Int | None = None, connect_point: str | Slot | None = None, wire: str | ProtoFluxWireManager | None = None, node_input: str | ISyncRef | None = None, input_type: Type | str | None = None, *, component: workers.Component | None = None) -> None:
