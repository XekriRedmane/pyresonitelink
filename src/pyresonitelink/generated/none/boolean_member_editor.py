...
class BooleanMemberEditor(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, continuous: bool | None = None, path: str | None = None, target: str | IField | None = None, check_box: str | Checkbox | None = None, state_drive: str | IField[bool] | None = None, button: str | Button | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def state_drive(self) -> str | None:
        """Target ID of the _stateDrive reference (targets IField[bool])."""
    ...
    @state_drive.setter
    def state_drive(self, target: str | IField[bool] | None) -> None:
        """Set the _stateDrive reference by target ID or IField[bool] instance."""
        target_id: str | None = target.id if isinstance(target, IField) else target  # type: ignore[assignment]
        member = self.get_member("_stateDrive")
        if isinstance(member, members.Reference):
            member.targetId = target_id
