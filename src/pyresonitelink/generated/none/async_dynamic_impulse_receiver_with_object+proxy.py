"""Generated component: AsyncDynamicImpulseReceiverWithObject+Proxy."""
...
class AsyncDynamicImpulseReceiverWithObject+Proxy(GenericComponent[T], IComponent, IWorldEventReceiver):
    """Wrapper for [ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseReceiverWithObject<>+Proxy.

    Parameterize with a value type::

        AsyncDynamicImpulseReceiverWithObject+Proxy[primitives.Float]
        AsyncDynamicImpulseReceiverWithObject+Proxy[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseReceiverWithObject<>+Proxy"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseReceiverWithObject<>+Proxy"
