"""Generated component: ProtoFluxInputListManager."""
...
class ProtoFluxInputListManager(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def elements(self) -> members.SyncList | None:
        """A list of slots representing the UIX elements of the list of inputs."""
    ...
    def elements(self, value: members.SyncList) -> None:
        """Set _elements. A list of slots representing the UIX elements of the list of inputs."""
        self.set_member("_elements", value)

    @property
    def input_type(self) -> Type | None:
        """The C# Type of the list of inputs for the list this is managing."""
    ...
    def input_type(self, value: Type | str) -> None:
        """Set InputType. The C# Type of the list of inputs for the list this is managing."""
        member = self.get_member("InputType")
    ...
    async def remove_element(self, resolink: protocols.ResoniteLinkClient, button: str, event_data: str, debug: bool = False) -> dict:
        """Called when the remove button is touched.
