...
class RefProxy(GenericComponent[T], ILastValueProxy[T], IWorldEventReceiver):
    """Wrapper for [ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.RefProxy<>.
    ...
    COMPONENT_TYPE = "[ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.RefProxy<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFlux.Nodes.FrooxEngine]ProtoFlux.Runtimes.Execution.Nodes.Actions.RefProxy<>"

    def __init__(self, node: str | IProtoFluxNode | None = None, last: str | T | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def last(self) -> str | None:
        """Target ID of the Last reference (targets T)."""
    ...
    @last.setter
    def last(self, target: str | T | None) -> None:
        """Set the Last reference by target ID or T instance."""
