...
class LocomotionAnimationHandMetrics(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, shoulder_separation: np.float32 | None = None, shoulder_height: np.float32 | None = None, shoulder_offset: np.float32 | None = None, hand_offset: np.float32 | None = None, arm_length: np.float32 | None = None, hand_palm_distance: np.float32 | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def shoulder_separation(self) -> np.float32 | None:
    ...
    def shoulder_separation(self, value: np.float32) -> None:
    ...
    @property
    def shoulder_height(self) -> np.float32 | None:
    ...
    def shoulder_height(self, value: np.float32) -> None:
    ...
    @property
    def shoulder_offset(self) -> np.float32 | None:
    ...
    def shoulder_offset(self, value: np.float32) -> None:
    ...
    @property
    def hand_offset(self) -> np.float32 | None:
    ...
    @hand_offset.setter
    def hand_offset(self, value: np.float32) -> None:
    ...
    @property
    def arm_length(self) -> np.float32 | None:
    ...
    @arm_length.setter
    def arm_length(self, value: np.float32) -> None:
    ...
    @property
    def hand_palm_distance(self) -> np.float32 | None:
    ...
    def hand_palm_distance(self, value: np.float32) -> None:
