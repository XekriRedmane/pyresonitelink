"""Generated component: AvatarVoiceSourceAssigner."""
...
class AvatarVoiceSourceAssigner(GeneratedComponent, IAvatarObjectComponent, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.CommonAvatar.AvatarVoiceSourceAssigner"

    def __init__(self, target_reference: str | SyncRef[IWorldAudioDataSource] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def target_reference(self, target: str | SyncRef[IWorldAudioDataSource] | None) -> None:
        """Set the TargetReference reference by target ID or SyncRef[IWorldAudioDataSource] instance."""
