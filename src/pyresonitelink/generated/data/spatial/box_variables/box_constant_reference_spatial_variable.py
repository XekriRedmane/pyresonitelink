...
class BoxConstantReferenceSpatialVariable(GenericComponent[T], ISpatialVariable[T], IComponent, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        BoxConstantReferenceSpatialVariable[np.float32]
    ...
    def __init__(self, variable_name: str | None = None, priority: np.int32 | None = None, size: primitives.Float3 | None = None, blend_distance: np.float32 | None = None, reference: str | T | None = None, *, component: workers.Component | None = None) -> None:
