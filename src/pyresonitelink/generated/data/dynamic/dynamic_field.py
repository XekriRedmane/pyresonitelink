...
class DynamicField(GenericComponent[T], IDynamicVariable[T], IComponent, IWorldEventReceiver):
    ...
    def __init__(self, variable_name: str | None = None, target_field: str | IField[T] | None = None, override_on_link: bool | None = None, *, component: workers.Component | None = None) -> None:
