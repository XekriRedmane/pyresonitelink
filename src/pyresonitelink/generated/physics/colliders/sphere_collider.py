...
class SphereCollider(GeneratedComponent, IHighlightable, ISweepableCollider, ICustomInspector):
    ...
    def __init__(self, offset: primitives.Float3 | None = None, mass: np.float32 | None = None, character_collider: bool | None = None, ignore_raycasts: bool | None = None, radius: np.float32 | None = None, *, component: workers.Component | None = None) -> None:
