...
class SnapPlane(GeneratedComponent, IPointSnappable, IUIInterface, IWorldEventReceiver):
    ...
    def __init__(self, normal: primitives.Float3 | None = None, snap_parent: str | Slot | None = None, *, component: workers.Component | None = None) -> None:
