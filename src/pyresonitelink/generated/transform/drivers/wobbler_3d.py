...
class Wobbler3D(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Wobbler3D.

    Category: Transform/Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Wobbler3D"

    def __init__(self, target: str | IField[primitives.Float3] | None = None, offset: primitives.Float3 | None = None, speed: primitives.Float3 | None = None, magnitude: primitives.Float3 | None = None, seed: primitives.Float3 | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @magnitude.setter
    def magnitude(self, value: primitives.Float3) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Magnitude", fields.FieldFloat3(value=value)
            )
    ...
    @seed.setter
    def seed(self, value: primitives.Float3) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Seed", fields.FieldFloat3(value=value)
            )
