...
class Wobbler1D(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Wobbler1D.
    ...
    def magnitude(self, value: np.float32) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Magnitude", fields.FieldFloat(value=value)
            )
    ...
    def seed(self, value: np.float32) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Seed", fields.FieldFloat(value=value)
            )
