"""Generated component: LinearRotationMapper."""
...
class LinearRotationMapper(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    @property
    def target_min(self) -> primitives.FloatQ | None:
    ...
    @target_min.setter
    def target_min(self, value: primitives.FloatQ) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "TargetMin", fields.FieldFloatQ(value=value)
            )

    @property
    def target_max(self) -> primitives.FloatQ | None:
    ...
    @target_max.setter
    def target_max(self, value: primitives.FloatQ) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "TargetMax", fields.FieldFloatQ(value=value)
            )
