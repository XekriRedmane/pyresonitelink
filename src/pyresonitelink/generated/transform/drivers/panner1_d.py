...
class Panner1D(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Panner1D.
    ...
    def offset(self, value: np.float32) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_offset", fields.FieldFloat(value=value)
            )
    ...
    def pre_offset(self, value: np.float32) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_preOffset", fields.FieldFloat(value=value)
            )
    ...
    def speed(self, value: np.float32) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_speed", fields.FieldFloat(value=value)
            )
    ...
    def repeat(self, value: np.float32) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_repeat", fields.FieldFloat(value=value)
            )
