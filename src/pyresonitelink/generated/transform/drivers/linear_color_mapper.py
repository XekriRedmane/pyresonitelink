...
class LinearColorMapper(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, source: str | IValue[np.float32] | None = None, target: str | IField[primitives.ColorX] | None = None, source_min: np.float32 | None = None, source_max: np.float32 | None = None, target_min: primitives.ColorX | None = None, target_max: primitives.ColorX | None = None, allow_reverse_mapping: bool | None = None, clamp: bool | None = None, *, component: workers.Component | None = None) -> None:
