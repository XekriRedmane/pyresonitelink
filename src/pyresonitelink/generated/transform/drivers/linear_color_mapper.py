"""Generated component: LinearColorMapper."""
...
class LinearColorMapper(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.LinearColorMapper.

    Category: Transform/Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.LinearColorMapper"

    def __init__(self, source: str | IValue[primitives.Float] | None = None, target: str | IField[primitives.ColorX] | None = None, source_min: primitives.Float | None = None, source_max: primitives.Float | None = None, target_min: primitives.ColorX | None = None, target_max: primitives.ColorX | None = None, allow_reverse_mapping: primitives.Bool | None = None, clamp: primitives.Bool | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def target_min(self) -> primitives.ColorX | None:
    ...
    @target_min.setter
    def target_min(self, value: primitives.ColorX) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "TargetMin", fields.FieldColorX(value=value)
            )

    @property
    def target_max(self) -> primitives.ColorX | None:
    ...
    @target_max.setter
    def target_max(self, value: primitives.ColorX) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "TargetMax", fields.FieldColorX(value=value)
            )
