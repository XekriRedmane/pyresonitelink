"""Generated component: Float2Driver."""
...
class Float2Driver(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Float2Driver"

    def __init__(self, x: str | Sync[primitives.Float] | None = None, y: str | Sync[primitives.Float] | None = None, target: str | IField[primitives.Float2] | None = None, *, component: workers.Component | None = None) -> None:
