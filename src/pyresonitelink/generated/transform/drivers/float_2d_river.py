...
class Float2Driver(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, x: str | Sync[np.float32] | None = None, y: str | Sync[np.float32] | None = None, target: str | IField[primitives.Float2] | None = None, *, component: workers.Component | None = None) -> None:
