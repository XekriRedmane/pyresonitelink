...
class LinearMapper2D(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, source: str | IValue[np.float32] | None = None, target: str | IField[primitives.Float2] | None = None, source_min: np.float32 | None = None, source_max: np.float32 | None = None, target_min: primitives.Float2 | None = None, target_max: primitives.Float2 | None = None, allow_reverse_mapping: bool | None = None, clamp: bool | None = None, *, component: workers.Component | None = None) -> None:
