"""Generated component: LinearMapper2D."""
...
* LinearMapper4D
    ...
    def __init__(self, source: str | IValue[primitives.Float] | None = None, target: str | IField[primitives.Float2] | None = None, source_min: primitives.Float | None = None, source_max: primitives.Float | None = None, target_min: primitives.Float2 | None = None, target_max: primitives.Float2 | None = None, allow_reverse_mapping: primitives.Bool | None = None, clamp: primitives.Bool | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @target_min.setter
    def target_min(self, value: primitives.Float2) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "TargetMin", fields.FieldFloat2(value=value)
            )
    ...
    @target_max.setter
    def target_max(self, value: primitives.Float2) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "TargetMax", fields.FieldFloat2(value=value)
            )
