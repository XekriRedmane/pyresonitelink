...
class Panner2D(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, target: str | IField[primitives.Float2] | None = None, offset: primitives.Float2 | None = None, pre_offset: primitives.Float2 | None = None, speed: primitives.Float2 | None = None, repeat: primitives.Float2 | None = None, ping_pong: primitives.Bool | None = None, *, component: workers.Component | None = None) -> None:
