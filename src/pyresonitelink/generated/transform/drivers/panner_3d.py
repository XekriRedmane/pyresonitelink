...
class Panner3D(GeneratedComponent, IComponent, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.Panner3D.

    Category: Transform/Drivers
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.Panner3D"

    def __init__(self, target: str | IField[primitives.Float3] | None = None, offset: primitives.Float3 | None = None, pre_offset: primitives.Float3 | None = None, speed: primitives.Float3 | None = None, repeat: primitives.Float3 | None = None, ping_pong: primitives.Bool | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def offset(self, value: primitives.Float3) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_offset", fields.FieldFloat3(value=value)
            )

    @property
    def pre_offset(self) -> primitives.Float3 | None:
    ...
    @pre_offset.setter
    def pre_offset(self, value: primitives.Float3) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_preOffset", fields.FieldFloat3(value=value)
            )
    ...
    @property
    def repeat(self) -> primitives.Float3 | None:
    ...
    @repeat.setter
    def repeat(self, value: primitives.Float3) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "_repeat", fields.FieldFloat3(value=value)
            )
