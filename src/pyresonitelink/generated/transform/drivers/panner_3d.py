...
class Panner3D(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    def __init__(self, target: str | IField[primitives.Float3] | None = None, offset: primitives.Float3 | None = None, pre_offset: primitives.Float3 | None = None, speed: primitives.Float3 | None = None, repeat: primitives.Float3 | None = None, ping_pong: bool | None = None, *, component: workers.Component | None = None) -> None:
