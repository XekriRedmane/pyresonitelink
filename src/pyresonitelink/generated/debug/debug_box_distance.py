"""Generated component: DebugBoxDistance."""
...
class DebugBoxDistance(GeneratedComponent, IComponent, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.DebugBoxDistance"

    def __init__(self, size: primitives.Float3 | None = None, *, component: workers.Component | None = None) -> None:
