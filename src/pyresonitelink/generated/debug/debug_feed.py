...
See Data Feeds.
    ...
    def category_count(self) -> primitives.Int | None:
        """The amount of categories to put at the beginning of the feed."""
    ...
    def label_item_count(self) -> primitives.Int | None:
        """The amount of label Feed items to put at the beginning of the feed."""
    ...
    def string_item_count(self) -> primitives.Int | None:
        """The amount of String fields generated by the feed."""
    ...
    def string_values(self, value: members.SyncList) -> None:
        """Set StringValues. Is automatically filled with values driven by the content of Feed value fields generated by the feed mapper creating templates from the data in this feed."""
