...
class HyperlinkDisplayInterface(GeneratedComponent, IItemMetadataSource, IWorldEventReceiver):
    ...
    def __init__(self, item_name: str | IField[str] | None = None, spawning_user: str | UserRef | None = None, spawning_user_id: str | IField[str] | None = None, is_instance: bool | None = None, url: str | IField[str] | None = None, url_string: str | IField[str] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def url_string(self) -> str | None:
        """Target ID of the UrlString reference (targets IField[str])."""
    ...
    @url_string.setter
    def url_string(self, target: str | IField[str] | None) -> None:
        """Set the UrlString reference by target ID or IField[str] instance."""
        target_id: str | None = target.id if isinstance(target, IField) else target  # type: ignore[assignment]
        member = self.get_member("UrlString")
        if isinstance(member, members.Reference):
            member.targetId = target_id
