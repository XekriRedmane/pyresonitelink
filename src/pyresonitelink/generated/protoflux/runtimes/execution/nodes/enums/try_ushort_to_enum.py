...
class TryUshortToEnum(GenericComponent[T], INodeValueOutput[T], IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, value: str | INodeValueOutput[np.uint16] | None = None, fail_value: str | INodeValueOutput[E] | None = None, only_defined: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def value(self) -> str | None:
        """Target ID of the Value reference (targets INodeValueOutput[np.uint16])."""
    ...
    @value.setter
    def value(self, target: str | INodeValueOutput[np.uint16] | None) -> None:
        """Set the Value reference by target ID or INodeValueOutput[np.uint16] instance."""
