...
class TryUshortToEnum(GenericComponent[T], INodeValueOutput[T], IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Enums.TryUshortToEnum<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Enums

    Parameterize with a value type::

        TryUshortToEnum[primitives.Float]
        TryUshortToEnum[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Enums.TryUshortToEnum<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Enums.TryUshortToEnum<>"

    def __init__(self, value: str | INodeValueOutput[primitives.UShort] | None = None, fail_value: str | INodeValueOutput[E] | None = None, only_defined: str | INodeValueOutput[primitives.Bool] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def value(self) -> str | None:
        """Target ID of the Value reference (targets INodeValueOutput[primitives.UShort])."""
    ...
    @value.setter
    def value(self, target: str | INodeValueOutput[primitives.UShort] | None) -> None:
        """Set the Value reference by target ID or INodeValueOutput[primitives.UShort] instance."""
