...
class TrySbyteToEnum(GenericComponent[T], INodeValueOutput[T], IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        TrySbyteToEnum[primitives.Float]
    ...
    def __init__(self, value: str | INodeValueOutput[primitives.SByte] | None = None, fail_value: str | INodeValueOutput[E] | None = None, only_defined: str | INodeValueOutput[primitives.Bool] | None = None, *, component: workers.Component | None = None) -> None:
