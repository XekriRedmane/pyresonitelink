...
class TrySbyteToEnum(GenericComponent[T], INodeValueOutput[T], IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Enums.TrySbyteToEnum<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Enums

    Parameterize with a value type::

        TrySbyteToEnum[np.float32]
        TrySbyteToEnum[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Enums.TrySbyteToEnum<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Enums.TrySbyteToEnum<>"

    def __init__(self, value: str | INodeValueOutput[np.int8] | None = None, fail_value: str | INodeValueOutput[E] | None = None, only_defined: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def value(self) -> str | None:
        """Target ID of the Value reference (targets INodeValueOutput[np.int8])."""
    ...
    @value.setter
    def value(self, target: str | INodeValueOutput[np.int8] | None) -> None:
        """Set the Value reference by target ID or INodeValueOutput[np.int8] instance."""
