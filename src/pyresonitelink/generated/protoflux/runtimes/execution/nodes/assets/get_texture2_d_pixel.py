...
from pyresonitelink.generated._types.texture2_d import Texture2D
...
class GetTexture2D_Pixel(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Assets.GetTexture2D_Pixel.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Assets
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Assets.GetTexture2D_Pixel"

    def __init__(self, texture: str | INodeObjectOutput[Texture2D] | None = None, position: str | INodeValueOutput[primitives.Int2] | None = None, mip_level: str | INodeValueOutput[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def position(self) -> str | None:
        """Target ID of the Position reference (targets INodeValueOutput[primitives.Int2])."""
    ...
    @position.setter
    def position(self, target: str | INodeValueOutput[primitives.Int2] | None) -> None:
        """Set the Position reference by target ID or INodeValueOutput[primitives.Int2] instance."""
