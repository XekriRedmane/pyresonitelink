"""Generated component: DynamicVariableObjectInputWithEvents."""
...
class DynamicVariableObjectInputWithEvents(GenericComponent[T], IProtoFluxEngineProxyNode, IMappableNode, IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Variables.DynamicVariableObjectInputWithEvents<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Variables/Dynamic

    Parameterize with a value type::

        DynamicVariableObjectInputWithEvents[primitives.Float]
        DynamicVariableObjectInputWithEvents[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Variables.DynamicVariableObjectInputWithEvents<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Variables.DynamicVariableObjectInputWithEvents<>"

    def __init__(self, variable_name: str | IGlobalValueProxy[primitives.String] | None = None, detecting_user: str | INodeObjectOutput[User] | None = None, on_space_linked: str | ISyncNodeOperation | None = None, on_space_unlinked: str | ISyncNodeOperation | None = None, *, component: workers.Component | None = None) -> None:
