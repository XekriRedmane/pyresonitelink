"""Generated component: CreateDynamicObjectVariable."""
...
class CreateDynamicObjectVariable(GenericComponent[T], IMappableNode, ISyncNodeOperation, IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Variables.CreateDynamicObjectVariable<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Variables/Dynamic

    Parameterize with a value type::

        CreateDynamicObjectVariable[primitives.Float]
        CreateDynamicObjectVariable[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Variables.CreateDynamicObjectVariable<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Variables.CreateDynamicObjectVariable<>"

    def __init__(self, target: str | INodeObjectOutput[Slot] | None = None, path: str | INodeObjectOutput[primitives.String] | None = None, on_not_found: str | INodeOperation | None = None, on_created: str | INodeOperation | None = None, on_already_exists: str | INodeOperation | None = None, on_failed: str | INodeOperation | None = None, create_directly_on_target: str | INodeValueOutput[primitives.Bool] | None = None, create_non_persistent: str | INodeValueOutput[primitives.Bool] | None = None, initial_value: str | INodeObjectOutput[T] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def initial_value(self) -> str | None:
        """Target ID of the InitialValue reference (targets INodeObjectOutput[T])."""
    ...
    def initial_value(self, target: str | INodeObjectOutput[T] | None) -> None:
        """Set the InitialValue reference by target ID or INodeObjectOutput[T] instance."""
        target_id: str | None = target.id if isinstance(target, INodeObjectOutput) else target  # type: ignore[assignment]
        member = self.get_member("InitialValue")
        if isinstance(member, members.Reference):
            member.targetId = target_id
