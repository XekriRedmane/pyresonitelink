"""Generated component: ReadObjectCloudVariable."""
...
class ReadObjectCloudVariable(GenericComponent[T], IAsyncNodeOperation, IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Cloud.ReadObjectCloudVariable<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Variables/Cloud

    Parameterize with a value type::

        ReadObjectCloudVariable[primitives.Float]
        ReadObjectCloudVariable[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Cloud.ReadObjectCloudVariable<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Cloud.ReadObjectCloudVariable<>"

    def __init__(self, path: str | INodeObjectOutput[primitives.String] | None = None, variable_owner_id: str | INodeObjectOutput[primitives.String] | None = None, on_request: str | INodeOperation | None = None, on_done: str | INodeOperation | None = None, on_fail: str | INodeOperation | None = None, *, component: workers.Component | None = None) -> None:
