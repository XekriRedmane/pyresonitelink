...
class ColorToHexCode(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Color.ColorToHexCode.
    ...
    def __init__(self, color: str | INodeValueOutput[primitives.Color] | None = None, short_form: str | INodeValueOutput[bool] | None = None, include_alpha: str | INodeValueOutput[bool] | None = None, prefix: str | INodeObjectOutput[str] | None = None, *, component: workers.Component | None = None) -> None:
