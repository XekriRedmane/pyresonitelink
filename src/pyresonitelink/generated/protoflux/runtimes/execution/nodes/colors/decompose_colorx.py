...
class DecomposeColorX(GeneratedComponent, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Color.DecomposeColorX"
    ...
    @property
    def base_color(self) -> members.EmptyElement | None:
        """The BaseColor member."""
    ...
    @base_color.setter
    def base_color(self, value: members.EmptyElement) -> None:
        """Set the BaseColor member."""
        self.set_member("BaseColor", value)
