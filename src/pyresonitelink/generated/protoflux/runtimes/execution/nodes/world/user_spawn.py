...
class UserSpawn(GeneratedComponent, IProtoFluxEngineProxyNode, IMappableNode, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Worlds.UserSpawn.
    ...
    def __init__(self, only_host: str | INodeValueOutput[bool] | None = None, on_spawn: str | ISyncNodeOperation | None = None, *, component: workers.Component | None = None) -> None:
