...
class UserLeft(GeneratedComponent, IProtoFluxEngineProxyNode, IMappableNode, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, only_host: str | INodeValueOutput[primitives.Bool] | None = None, on_left: str | ISyncNodeOperation | None = None, *, component: workers.Component | None = None) -> None:
