...
class GET_String(GeneratedComponent, IAsyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Network.GET_String.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Network
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Network.GET_String"

    def __init__(self, url: str | INodeObjectOutput[str] | None = None, on_sent: str | INodeOperation | None = None, on_response: str | INodeOperation | None = None, on_error: str | INodeOperation | None = None, on_denied: str | INodeOperation | None = None, *, component: workers.Component | None = None) -> None:
