...
class WebsocketTextMessageSender(GeneratedComponent, IAsyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, client: str | INodeObjectOutput[WebsocketClient] | None = None, data: str | INodeObjectOutput[str] | None = None, on_send_start: str | INodeOperation | None = None, on_sent: str | INodeOperation | None = None, on_send_error: str | INodeOperation | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def data(self) -> str | None:
        """Target ID of the Data reference (targets INodeObjectOutput[str])."""
    ...
    @data.setter
    def data(self, target: str | INodeObjectOutput[str] | None) -> None:
        """Set the Data reference by target ID or INodeObjectOutput[str] instance."""
        target_id: str | None = target.id if isinstance(target, INodeObjectOutput) else target  # type: ignore[assignment]
        member = self.get_member("Data")
        if isinstance(member, members.Reference):
            member.targetId = target_id
