...
class ToString_FloatQ(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ParsingFormatting.ToString_FloatQ.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Strings
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ParsingFormatting.ToString_FloatQ"

    def __init__(self, v: str | INodeValueOutput[primitives.FloatQ] | None = None, format_: str | INodeObjectOutput[primitives.String] | None = None, format_provider: str | INodeObjectOutput[IFormatProvider] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def v(self) -> str | None:
        """Target ID of the V reference (targets INodeValueOutput[primitives.FloatQ])."""
    ...
    @v.setter
    def v(self, target: str | INodeValueOutput[primitives.FloatQ] | None) -> None:
        """Set the V reference by target ID or INodeValueOutput[primitives.FloatQ] instance."""
