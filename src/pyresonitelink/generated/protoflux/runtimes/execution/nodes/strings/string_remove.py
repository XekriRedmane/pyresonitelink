...
class StringRemove(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Strings.StringRemove"

    def __init__(self, str_: str | INodeObjectOutput[primitives.String] | None = None, start_index: str | INodeValueOutput[primitives.Int] | None = None, length: str | INodeValueOutput[primitives.Int] | None = None, *, component: workers.Component | None = None) -> None:
