...
class ToString_Ulong3(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ParsingFormatting.ToString_Ulong3.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Strings
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ParsingFormatting.ToString_Ulong3"

    def __init__(self, v: str | INodeValueOutput[primitives.ULong3] | None = None, format_: str | INodeObjectOutput[primitives.String] | None = None, format_provider: str | INodeObjectOutput[IFormatProvider] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def v(self) -> str | None:
        """Target ID of the V reference (targets INodeValueOutput[primitives.ULong3])."""
    ...
    @v.setter
    def v(self, target: str | INodeValueOutput[primitives.ULong3] | None) -> None:
        """Set the V reference by target ID or INodeValueOutput[primitives.ULong3] instance."""
