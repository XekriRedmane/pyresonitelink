...
class ToString_Decimal(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ParsingFormatting.ToString_Decimal.
    ...
    @property
    def v(self) -> str | None:
        """Target ID of the V reference (targets INodeValueOutput[Decimal])."""
    ...
    @v.setter
    def v(self, target: str | INodeValueOutput[Decimal] | None) -> None:
        """Set the V reference by target ID or INodeValueOutput[Decimal] instance."""
