...
class FromUTF32(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, utf32: str | INodeValueOutput[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def utf32(self) -> str | None:
        """Target ID of the UTF32 reference (targets INodeValueOutput[np.int32])."""
    ...
    @utf32.setter
    def utf32(self, target: str | INodeValueOutput[np.int32] | None) -> None:
        """Set the UTF32 reference by target ID or INodeValueOutput[np.int32] instance."""
