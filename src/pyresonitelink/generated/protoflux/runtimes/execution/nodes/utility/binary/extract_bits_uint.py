...
class ExtractBits_uint(GeneratedComponent, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Binary.ExtractBits_uint.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Utility/Binary
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Binary.ExtractBits_uint"

    def __init__(self, integer: str | INodeValueOutput[primitives.UInt] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def integer(self) -> str | None:
        """Target ID of the Integer reference (targets INodeValueOutput[primitives.UInt])."""
    ...
    @integer.setter
    def integer(self, target: str | INodeValueOutput[primitives.UInt] | None) -> None:
        """Set the Integer reference by target ID or INodeValueOutput[primitives.UInt] instance."""
