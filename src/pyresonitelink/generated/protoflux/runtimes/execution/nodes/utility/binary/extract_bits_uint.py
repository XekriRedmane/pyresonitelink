...
class ExtractBits_uint(GeneratedComponent, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, integer: str | INodeValueOutput[np.uint32] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def integer(self) -> str | None:
        """Target ID of the Integer reference (targets INodeValueOutput[np.uint32])."""
    ...
    @integer.setter
    def integer(self, target: str | INodeValueOutput[np.uint32] | None) -> None:
        """Set the Integer reference by target ID or INodeValueOutput[np.uint32] instance."""
