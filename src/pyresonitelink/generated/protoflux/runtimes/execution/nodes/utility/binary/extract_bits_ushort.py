...
class ExtractBits_ushort(GeneratedComponent, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, integer: str | INodeValueOutput[primitives.UShort] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def integer(self) -> str | None:
        """Target ID of the Integer reference (targets INodeValueOutput[primitives.UShort])."""
    ...
    @integer.setter
    def integer(self, target: str | INodeValueOutput[primitives.UShort] | None) -> None:
        """Set the Integer reference by target ID or INodeValueOutput[primitives.UShort] instance."""
