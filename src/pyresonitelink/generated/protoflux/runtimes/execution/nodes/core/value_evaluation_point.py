...
Evaluation Points are used internally in FrooxEngine as a way to evaluate a chain of ProtoFlux.
    ...
    Parameterize with a value type::
        ...
        ValueEvaluationPoint[primitives.Float]
        ValueEvaluationPoint[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ValueEvaluationPoint<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ValueEvaluationPoint<>"
