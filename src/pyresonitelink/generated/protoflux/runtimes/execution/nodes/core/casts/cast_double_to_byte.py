...
class Cast_double_To_byte(GeneratedComponent, ICast, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Casts.Cast_double_To_byte.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Core/Casts
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Casts.Cast_double_To_byte"
