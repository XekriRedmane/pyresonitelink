"""Generated component: WriteValueToGlobal."""
...
class WriteValueToGlobal(GeneratedComponent, IGlobalRefWrite, ISyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.WriteValueToGlobal<,>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Core
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.WriteValueToGlobal<,>"

    def __init__(self, global_: str | IGlobalValueProxy[T] | None = None, value: str | INodeValueOutput[T] | None = None, on_written: str | INodeOperation | None = None, on_fail: str | INodeOperation | None = None, *, component: workers.Component | None = None) -> None:
