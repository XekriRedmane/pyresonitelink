...
class GenericValueDisplay(GenericComponent[T], IProtoFluxNodePackUnpackListener, IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        GenericValueDisplay[np.float32]
    ...
    def __init__(self, input_: str | INodeValueOutput[T] | None = None, display_text: str | IField[str] | None = None, *, component: workers.Component | None = None) -> None:
