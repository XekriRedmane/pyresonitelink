...
class Cast_doubleQ_To_double4(GeneratedComponent, ICast, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Casts.Cast_doubleQ_To_double4.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Core/Casts
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Casts.Cast_doubleQ_To_double4"

    def __init__(self, input_: str | INodeValueOutput[primitives.DoubleQ] | None = None, *, component: workers.Component | None = None) -> None:
