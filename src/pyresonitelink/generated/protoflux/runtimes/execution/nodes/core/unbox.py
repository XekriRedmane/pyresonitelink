...
* Microsoft documentation on C# boxing and unboxing
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Unbox<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Unbox<>"

    def __init__(self, input_: str | INodeObjectOutput[object] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @input_.setter
    def input_(self, target: str | INodeObjectOutput[object] | None) -> None:
        """Set the Input reference by target ID or INodeObjectOutput[object] instance."""
