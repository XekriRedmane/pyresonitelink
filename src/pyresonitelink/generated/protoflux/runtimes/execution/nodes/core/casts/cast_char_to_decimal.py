...
class Cast_char_To_decimal(GeneratedComponent, ICast, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Casts.Cast_char_To_decimal.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Core/Casts
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Casts.Cast_char_To_decimal"
