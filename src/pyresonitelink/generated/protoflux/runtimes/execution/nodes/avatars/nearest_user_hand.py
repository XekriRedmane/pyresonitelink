...
class NearestUserHand(GeneratedComponent, IMappableNode, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def slot(self, value: members.EmptyElement) -> None:
        """Set Slot. The slot of the hand when found."""
    ...
    def user(self, value: members.EmptyElement) -> None:
        """Set User. The user of the hand that was found."""
    ...
    def distance(self, value: members.EmptyElement) -> None:
        """Set Distance. How far away the found hand was."""
    ...
    def chirality(self, value: members.EmptyElement) -> None:
        """Set Chirality. The side of the hand that was found. Left or Right or -1."""
