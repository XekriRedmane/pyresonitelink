...
class FromUnixSeconds(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, unix_seconds: str | INodeValueOutput[np.int64] | None = None, is_local: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def unix_seconds(self) -> str | None:
        """Target ID of the UnixSeconds reference (targets INodeValueOutput[np.int64])."""
    ...
    @unix_seconds.setter
    def unix_seconds(self, target: str | INodeValueOutput[np.int64] | None) -> None:
        """Set the UnixSeconds reference by target ID or INodeValueOutput[np.int64] instance."""
