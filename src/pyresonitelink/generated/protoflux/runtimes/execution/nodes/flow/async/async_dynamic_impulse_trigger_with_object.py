"""Generated component: AsyncDynamicImpulseTriggerWithObject."""
...
class AsyncDynamicImpulseTriggerWithObject(GenericComponent[T], IAsyncNodeOperation, IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseTriggerWithObject<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Flow/Async

    Parameterize with a value type::

        AsyncDynamicImpulseTriggerWithObject[np.float32]
        AsyncDynamicImpulseTriggerWithObject[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseTriggerWithObject<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.AsyncDynamicImpulseTriggerWithObject<>"

    def __init__(self, next: str | INodeOperation | None = None, tag: str | INodeObjectOutput[str] | None = None, target_hierarchy: str | INodeObjectOutput[Slot] | None = None, exclude_disabled: str | INodeValueOutput[bool] | None = None, value: str | INodeObjectOutput[T] | None = None, *, component: workers.Component | None = None) -> None:
