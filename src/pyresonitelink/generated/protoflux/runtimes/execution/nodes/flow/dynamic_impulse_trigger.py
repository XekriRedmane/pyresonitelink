...
This node can be used in an async flow node chain as well, though the node chain for the receiver will not be async.
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.DynamicImpulseTrigger"

    def __init__(self, next: str | INodeOperation | None = None, tag: str | INodeObjectOutput[primitives.String] | None = None, target_hierarchy: str | INodeObjectOutput[Slot] | None = None, exclude_disabled: str | INodeValueOutput[primitives.Bool] | None = None, *, component: workers.Component | None = None) -> None:
