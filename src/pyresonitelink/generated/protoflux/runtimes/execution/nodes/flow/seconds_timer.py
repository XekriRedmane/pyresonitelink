...
class SecondsTimer(GeneratedComponent, IExecutionUpdateReceiver, IMappableNode, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, updating_user: str | IGlobalValueProxy[User] | None = None, skip_if_null: str | IGlobalValueProxy[bool] | None = None, on_update: str | ISyncNodeOperation | None = None, interval: str | INodeValueOutput[np.float32] | None = None, *, component: workers.Component | None = None) -> None:
