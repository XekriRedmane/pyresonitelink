"""Generated component: FireOnObjectValueChange."""
...
class FireOnObjectValueChange(GenericComponent[T], IProtoFluxEngineProxyNode, IMappableNode, IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.FireOnObjectValueChange<>.
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.FireOnObjectValueChange<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.FireOnObjectValueChange<>"

    def __init__(self, only_for_user: str | INodeObjectOutput[User] | None = None, on_changed: str | ISyncNodeOperation | None = None, value: str | INodeObjectOutput[T] | None = None, *, component: workers.Component | None = None) -> None:
