"""Generated component: ObjectIndirectWrite."""
...
class ObjectIndirectWrite(GenericComponent[T]):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ObjectIndirectWrite<>.
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ObjectIndirectWrite<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ObjectIndirectWrite<>"

    def __init__(self, on_written: str | INodeOperation | None = None, on_fail: str | INodeOperation | None = None, variable: str | INodeObjectOutput[IVariable] | None = None, value: str | INodeObjectOutput[T] | None = None, *, component: workers.Component | None = None) -> None:
