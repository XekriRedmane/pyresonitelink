...
class ValueIndirectDecrement(GenericComponent[T]):
    ...
    Parameterize with a value type::
        ...
        ValueIndirectDecrement[primitives.Float]
        ValueIndirectDecrement[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.ValueIndirectDecrement<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Actions.ValueIndirectDecrement<>"
