"""Generated component: ObjectIndirectWriteLatch."""
...
class ObjectIndirectWriteLatch(GenericComponent[T]):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ObjectIndirectWriteLatch<>.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Actions/Indirect

    Parameterize with a value type::

        ObjectIndirectWriteLatch[primitives.Float]
        ObjectIndirectWriteLatch[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ObjectIndirectWriteLatch<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.ObjectIndirectWriteLatch<>"

    def __init__(self, on_set: str | INodeOperation | None = None, on_reset: str | INodeOperation | None = None, on_fail: str | INodeOperation | None = None, variable: str | INodeObjectOutput[IVariable] | None = None, set_value: str | INodeObjectOutput[T] | None = None, reset_value: str | INodeObjectOutput[T] | None = None, *, component: workers.Component | None = None) -> None:
