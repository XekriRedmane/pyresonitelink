...
class IsChildOf(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, instance: str | INodeObjectOutput[Slot] | None = None, other: str | INodeObjectOutput[Slot] | None = None, include_self: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def include_self(self) -> str | None:
        """Target ID of the IncludeSelf reference (targets INodeValueOutput[bool])."""
    ...
    @include_self.setter
    def include_self(self, target: str | INodeValueOutput[bool] | None) -> None:
        """Set the IncludeSelf reference by target ID or INodeValueOutput[bool] instance."""
