...
class SetSlotPersistentSelf(GeneratedComponent, ISyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, next: str | INodeOperation | None = None, instance: str | INodeObjectOutput[Slot] | None = None, persistent: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def persistent(self) -> str | None:
        """Target ID of the Persistent reference (targets INodeValueOutput[bool])."""
    ...
    @persistent.setter
    def persistent(self, target: str | INodeValueOutput[bool] | None) -> None:
        """Set the Persistent reference by target ID or INodeValueOutput[bool] instance."""
