...
class Pow_Double_Double2(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.Pow_Double_Double2.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Math
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.Pow_Double_Double2"

    def __init__(self, n: str | INodeValueOutput[primitives.Double] | None = None, power: str | INodeValueOutput[primitives.Double2] | None = None, *, component: workers.Component | None = None) -> None:
