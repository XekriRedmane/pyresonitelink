...
class VectorDeltaAngleRad_Double2(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.VectorDeltaAngleRad_Double2.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Math/Vectors
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.VectorDeltaAngleRad_Double2"

    def __init__(self, from_: str | INodeValueOutput[primitives.Double2] | None = None, to: str | INodeValueOutput[primitives.Double2] | None = None, *, component: workers.Component | None = None) -> None:
