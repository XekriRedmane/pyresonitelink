...
class RandomString(GeneratedComponent, INodeObjectOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, characters: str | INodeObjectOutput[str] | None = None, length: str | INodeValueOutput[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def characters(self) -> str | None:
        """Target ID of the Characters reference (targets INodeObjectOutput[str])."""
    ...
    @characters.setter
    def characters(self, target: str | INodeObjectOutput[str] | None) -> None:
        """Set the Characters reference by target ID or INodeObjectOutput[str] instance."""
