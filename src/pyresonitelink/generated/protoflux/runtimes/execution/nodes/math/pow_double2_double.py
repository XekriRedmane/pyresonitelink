...
class Pow_Double2_Double(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, n: str | INodeValueOutput[primitives.Double2] | None = None, power: str | INodeValueOutput[np.float64] | None = None, *, component: workers.Component | None = None) -> None:
