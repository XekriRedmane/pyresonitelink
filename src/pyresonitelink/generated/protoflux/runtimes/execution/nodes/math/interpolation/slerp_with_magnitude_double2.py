...
class SlerpWithMagnitude_Double2(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, from_: str | INodeValueOutput[primitives.Double2] | None = None, to: str | INodeValueOutput[primitives.Double2] | None = None, lerp: str | INodeValueOutput[np.float32] | None = None, *, component: workers.Component | None = None) -> None:
