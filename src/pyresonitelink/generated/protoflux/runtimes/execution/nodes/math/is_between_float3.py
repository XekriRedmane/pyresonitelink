...
class IsBetween_Float3(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.IsBetween_Float3.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Math
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.IsBetween_Float3"

    def __init__(self, value: str | INodeValueOutput[primitives.Float3] | None = None, min: str | INodeValueOutput[primitives.Float3] | None = None, max: str | INodeValueOutput[primitives.Float3] | None = None, *, component: workers.Component | None = None) -> None:
