...
class TrajectoryPosition(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, initial_velocity: str | INodeValueOutput[primitives.Float3] | None = None, gravity: str | INodeValueOutput[primitives.Float3] | None = None, drag: str | INodeValueOutput[np.float32] | None = None, time: str | INodeValueOutput[np.float32] | None = None, *, component: workers.Component | None = None) -> None:
