...
class ConstantSlerp_doubleQ(GeneratedComponent, INodeValueOutput, IExecutionUpdateReceiver, IMappableNode, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.ConstantSlerp_doubleQ.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Math/Interpolation
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.ConstantSlerp_doubleQ"

    def __init__(self, input_: str | INodeValueOutput[primitives.DoubleQ] | None = None, speed: str | INodeValueOutput[np.float32] | None = None, *, component: workers.Component | None = None) -> None:
