...
class ValueLerpUnclamped(GenericComponent[T], INodeValueOutput[T], IExecutionNode[T], INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    Parameterize with a value type::
        ...
        ValueLerpUnclamped[primitives.Float]
        ValueLerpUnclamped[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.ValueLerpUnclamped<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Math.ValueLerpUnclamped<>"

    def __init__(self, from_: str | INodeValueOutput[T] | None = None, to: str | INodeValueOutput[T] | None = None, lerp: str | INodeValueOutput[primitives.Float] | None = None, *, component: workers.Component | None = None) -> None:
