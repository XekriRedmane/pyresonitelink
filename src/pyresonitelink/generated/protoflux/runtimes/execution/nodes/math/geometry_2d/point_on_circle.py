...
class PointOnCircle(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, normalized_position: str | INodeValueOutput[np.float32] | None = None, radius: str | INodeValueOutput[np.float32] | None = None, *, component: workers.Component | None = None) -> None:
