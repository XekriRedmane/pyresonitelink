...
class Atan2_Double_Double4(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, y: str | INodeValueOutput[primitives.Double] | None = None, x: str | INodeValueOutput[primitives.Double4] | None = None, *, component: workers.Component | None = None) -> None:
