...
class LogN_Double_Double4(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, n: str | INodeValueOutput[primitives.Double] | None = None, base: str | INodeValueOutput[primitives.Double4] | None = None, *, component: workers.Component | None = None) -> None:
