...
class CosineLerp_Double3(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, a: str | INodeValueOutput[primitives.Double3] | None = None, b: str | INodeValueOutput[primitives.Double3] | None = None, lerp: str | INodeValueOutput[np.float32] | None = None, *, component: workers.Component | None = None) -> None:
