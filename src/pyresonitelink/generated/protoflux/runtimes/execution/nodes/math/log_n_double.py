...
class LogN_Double(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, n: str | INodeValueOutput[np.float64] | None = None, base: str | INodeValueOutput[np.float64] | None = None, *, component: workers.Component | None = None) -> None:
