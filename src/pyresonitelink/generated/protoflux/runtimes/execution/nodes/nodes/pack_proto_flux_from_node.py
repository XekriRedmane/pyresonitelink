...
class PackProtoFluxFromNode(GeneratedComponent, ISyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Nodes.PackProtoFluxFromNode"

    def __init__(self, next: str | INodeOperation | None = None, start_node: str | INodeObjectOutput[ProtoFluxNode] | None = None, target: str | INodeObjectOutput[Slot] | None = None, *, component: workers.Component | None = None) -> None:
