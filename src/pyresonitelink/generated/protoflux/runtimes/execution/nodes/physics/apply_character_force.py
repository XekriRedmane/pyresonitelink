...
class ApplyCharacterForce(GeneratedComponent, ISyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, next: str | INodeOperation | None = None, force: str | INodeValueOutput[primitives.Float3] | None = None, character: str | INodeObjectOutput[CharacterController] | None = None, ignore_mass: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
