...
class ApplyCharacterImpulse(GeneratedComponent, ISyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Physics.ApplyCharacterImpulse.
    ...
    def __init__(self, next: str | INodeOperation | None = None, impulse: str | INodeValueOutput[primitives.Float3] | None = None, character: str | INodeObjectOutput[CharacterController] | None = None, ignore_mass: str | INodeValueOutput[bool] | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            impulse: Initial value for Impulse.
    ...
    @impulse.setter
    def impulse(self, target: str | INodeValueOutput[primitives.Float3] | None) -> None:
        """Set the Impulse reference by target ID or INodeValueOutput[primitives.Float3] instance."""
