...
class CloseContextMenu(GeneratedComponent, ISyncNodeOperation, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Interaction.CloseContextMenu"

    def __init__(self, next: str | INodeOperation | None = None, summoner: str | INodeObjectOutput[IWorldElement] | None = None, *, component: workers.Component | None = None) -> None:
        """Initialize with optional member values.

        Args:
            next: Initial value for Next.
            summoner: Initial value for Summoner.
    ...
    @summoner.setter
    def summoner(self, target: str | INodeObjectOutput[IWorldElement] | None) -> None:
        """Set the Summoner reference by target ID or INodeObjectOutput[IWorldElement] instance."""
