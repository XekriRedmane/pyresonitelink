...
class UnpackColumns_Double4x4(GeneratedComponent, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.UnpackColumns_Double4x4.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Operators/Matrix
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.UnpackColumns_Double4x4"

    def __init__(self, matrix: str | INodeValueOutput[primitives.Double4x4] | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def column3(self) -> members.EmptyElement | None:
        """The Column3 member."""
    ...
    @column3.setter
    def column3(self, value: members.EmptyElement) -> None:
        """Set the Column3 member."""
        self.set_member("Column3", value)
