...
class MatrixElement_Float4x4(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.MatrixElement_Float4x4.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Operators/Matrix
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.MatrixElement_Float4x4"

    def __init__(self, matrix: str | INodeValueOutput[primitives.Float4x4] | None = None, row: str | INodeValueOutput[primitives.Int] | None = None, column: str | INodeValueOutput[primitives.Int] | None = None, *, component: workers.Component | None = None) -> None:
