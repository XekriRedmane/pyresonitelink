...
class RotateRight_Bool2(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.RotateRight_Bool2.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Operators/Boolean
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.RotateRight_Bool2"

    def __init__(self, a: str | INodeValueOutput[primitives.Bool2] | None = None, rotate: str | INodeValueOutput[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
