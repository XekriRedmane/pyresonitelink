...
class UnpackRows_Double4x4(GeneratedComponent, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """Wrapper for [ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.UnpackRows_Double4x4.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Operators/Matrix
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.UnpackRows_Double4x4"
    ...
    @property
    def row3(self) -> members.EmptyElement | None:
        """The Row3 member."""
    ...
    @row3.setter
    def row3(self, value: members.EmptyElement) -> None:
        """Set the Row3 member."""
        self.set_member("Row3", value)
