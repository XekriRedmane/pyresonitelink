...
class MatrixElement_Double3x3(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, matrix: str | INodeValueOutput[primitives.Double3x3] | None = None, row: str | INodeValueOutput[np.int32] | None = None, column: str | INodeValueOutput[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
