...
If you need to increment a value from an impulse, use the Increment node instead.|suggestion}}
    ...
    Parameterize with a value type::
        ...
        ValueAdd[primitives.Float]
        ValueAdd[primitives.Float3]
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.ValueAdd<>"
    _GENERIC_TYPE_TEMPLATE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Operators.ValueAdd<>"
