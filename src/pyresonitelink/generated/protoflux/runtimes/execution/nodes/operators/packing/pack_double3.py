...
class Pack_Double3(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, x: str | INodeValueOutput[primitives.Double] | None = None, y: str | INodeValueOutput[primitives.Double] | None = None, z: str | INodeValueOutput[primitives.Double] | None = None, *, component: workers.Component | None = None) -> None:
