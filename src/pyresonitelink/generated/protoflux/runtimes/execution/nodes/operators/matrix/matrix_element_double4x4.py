...
class MatrixElement_Double4x4(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    ...
    def __init__(self, matrix: str | INodeValueOutput[primitives.Double4x4] | None = None, row: str | INodeValueOutput[np.int32] | None = None, column: str | INodeValueOutput[np.int32] | None = None, *, component: workers.Component | None = None) -> None:
