...
class LeftHandPosition(GeneratedComponent, INodeValueOutput, IExecutionNode, INode, ICustomInspector, IObjectRoot, IWorldEventReceiver):
    """The Left Hand Position node takes in a reference of a UserRoot, and if that UserRoot is active or being used, it returns the left hand position value of the User.

    Category: ProtoFlux/Runtimes/Execution/Nodes/Users/User Root
    """

    COMPONENT_TYPE = "[ProtoFluxBindings]FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.FrooxEngine.Users.Roots.LeftHandPosition"
