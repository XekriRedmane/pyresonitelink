...
class ButtonRefRelay(GenericComponent[T], IButtonPressReceiver, IWorldEventReceiver):
    ...
    def __init__(self, double_press_delay: np.float32 | None = None, release_press_interval: np.float32 | None = None, argument: str | T | None = None, *, component: workers.Component | None = None) -> None:
