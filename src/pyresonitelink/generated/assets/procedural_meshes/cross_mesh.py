...
class CrossMesh(GeneratedComponent, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    ...
    def __init__(self, high_priority_integration: primitives.Bool | None = None, override_bounding_box: primitives.Bool | None = None, overriden_bounding_box: primitives.BoundingBox | None = None, profile: ColorProfile | str | None = None, size: primitives.Float | None = None, bar_ratio: primitives.Float | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def size(self) -> primitives.Float | None:
        """The size of the cross from end to end in local space."""
    ...
    def bar_ratio(self) -> primitives.Float | None:
        """This multiplied by size is how thick each bar is in local space."""
