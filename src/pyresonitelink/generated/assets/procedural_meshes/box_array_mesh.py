"""Generated component: BoxArrayMesh."""
...
class BoxArrayMesh(GeneratedComponent, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.BoxArrayMesh.

    Category: Assets/Procedural Meshes
    """

    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.BoxArrayMesh"
    ...
    @property
    def sizes(self) -> list[primitives.Float3] | None:
    ...
    @sizes.setter
    def sizes(self, value: list[primitives.Float3]) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Sizes", fields.ArrayFloat3(values=value)
            )
    ...
    @property
    def uv_scales(self) -> list[primitives.Float3] | None:
        """The UV_Scales array values."""
        member = self.get_member("UV_Scales")
        if member is None:
            return None
        return getattr(member, 'values', None)

    @uv_scales.setter
    def uv_scales(self, value: list[primitives.Float3]) -> None:
        """Set the UV_Scales array values."""
        member = self.get_member("UV_Scales")
        if member is not None:
            member.values = value  # type: ignore[attr-defined]
        else:
            self.set_member(
                "UV_Scales", fields.ArrayFloat3(values=value)
            )
