...
class PointMesh(GeneratedComponent, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    ...
    def rotations(self, value: list[primitives.Float]) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Rotations", fields.ArrayFloat(values=value)
            )
    ...
    def sort(self, value: primitives.Bool) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "Sort", fields.FieldBool(value=value)
            )
    ...
    @sort_point.setter
    def sort_point(self, value: primitives.Float3) -> None:
        """Set the SortPoint field value."""
        member = self.get_member("SortPoint")
        if member is not None:
            member.value = value  # type: ignore[attr-defined]
        else:
            self.set_member(
                "SortPoint", fields.FieldFloat3(value=value)
            )
