...
class BoxMesh(GeneratedComponent, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    ...
    **Behavior**: == Examples ==
    ...
    def __init__(self, high_priority_integration: primitives.Bool | None = None, override_bounding_box: primitives.Bool | None = None, overriden_bounding_box: primitives.BoundingBox | None = None, profile: ColorProfile | str | None = None, size: primitives.Float3 | None = None, uv_scale: primitives.Float3 | None = None, scale_uv_with_size: primitives.Bool | None = None, *, component: workers.Component | None = None) -> None:
