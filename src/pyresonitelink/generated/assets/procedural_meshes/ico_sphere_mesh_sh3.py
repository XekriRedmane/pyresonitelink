...
class IcoSphereMeshSH3(GeneratedComponent, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    ...
    @property
    def colors(self) -> SphericalHarmonicsL3 | None:
    ...
    @colors.setter
    def colors(self, value: SphericalHarmonicsL3 | str) -> None:
    ...
    @property
    def radius_multiplier(self) -> SphericalHarmonicsL3 | None:
    ...
    def radius_multiplier(self, value: SphericalHarmonicsL3 | str) -> None:
