"""Generated component: StandaloneRectMesh."""
...
class StandaloneRectMesh(GenericComponent[T], IAssetProvider[T], ICustomInspector, IWorldEventReceiver):
    ...
    def __init__(self, high_priority_integration: primitives.Bool | None = None, override_bounding_box: primitives.Bool | None = None, overriden_bounding_box: primitives.BoundingBox | None = None, profile: ColorProfile | str | None = None, rect: primitives.Rect | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def rect(self) -> primitives.Rect | None:
        """The part of the generated waveform to render."""
    ...
    def mesh(self) -> members.SyncObject | None:
        """The mesh parameters used to render this rect mesh. Usually takes an audio clip."""
    ...
    def mesh(self, value: members.SyncObject) -> None:
        """Set Mesh. The mesh parameters used to render this rect mesh. Usually takes an audio clip."""
