...
class GrayscaleMaterial(GeneratedComponent, IUIX_Material, ICustomInspector, IWorldEventReceiver):
    ...
    **Behavior**: This material acts as a filter which applies on top of other materials.
...
The Lerp field allows you to transition between having the filter off (0) and fully on (1).
    ...
    def __init__(self, high_priority_integration: primitives.Bool | None = None, rect: primitives.Rect | None = None, rect_clip: primitives.Bool | None = None, color_mask: ColorMask | str | None = None, stencil_comparison: StencilComparison | str | None = None, stencil_operation: StencilOperation | str | None = None, stencil_id: primitives.Byte | None = None, stencil_write_mask: primitives.Byte | None = None, stencil_read_mask: primitives.Byte | None = None, render_queue: primitives.Int | None = None, shader: str | IAssetProvider[Shader] | None = None, ratio_red: primitives.Float | None = None, ratio_green: primitives.Float | None = None, ratio_blue: primitives.Float | None = None, lerp: primitives.Float | None = None, gradient: str | IAssetProvider[ITexture2D] | None = None, blend_mode: BlendMode | str | None = None, sidedness: Sidedness | str | None = None, zwrite: ZWrite | str | None = None, ztest: ZTest | str | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            ratio_red: Initial value for RatioRed.
            ratio_green: Initial value for RatioGreen.
            ratio_blue: Initial value for RatioBlue.
            lerp: Initial value for Lerp.
            gradient: Initial value for Gradient.
        ...
        if shader is not None:
            self.shader = shader
        if ratio_red is not None:
            self.ratio_red = ratio_red
        if ratio_green is not None:
            self.ratio_green = ratio_green
        if ratio_blue is not None:
            self.ratio_blue = ratio_blue
        if lerp is not None:
            self.lerp = lerp
    ...
    def ratio_red(self, value: primitives.Float) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "RatioRed", fields.FieldFloat(value=value)
            )
    ...
    def ratio_green(self, value: primitives.Float) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "RatioGreen", fields.FieldFloat(value=value)
            )
    ...
    def ratio_blue(self, value: primitives.Float) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "RatioBlue", fields.FieldFloat(value=value)
            )
    ...
    def gradient(self) -> str | None:
        """Target ID of the Gradient reference (targets IAssetProvider[ITexture2D])."""
    ...
    @gradient.setter
    def gradient(self, target: str | IAssetProvider[ITexture2D] | None) -> None:
        """Set the Gradient reference by target ID or IAssetProvider[ITexture2D] instance."""
        target_id: str | None = target.id if isinstance(target, IAssetProvider) else target  # type: ignore[assignment]
        member = self.get_member("Gradient")
        if isinstance(member, members.Reference):
            member.targetId = target_id
