...
from pyresonitelink.generated._enums.unlit_texture_mode import UnlitTextureMode
...
class UI_UnlitMaterial(GeneratedComponent, ICommonMaterial, IUIX_Material, ICustomInspector, IWorldEventReceiver):
    ...
    def __init__(self, high_priority_integration: primitives.Bool | None = None, rect: primitives.Rect | None = None, rect_clip: primitives.Bool | None = None, color_mask: ColorMask | str | None = None, stencil_comparison: StencilComparison | str | None = None, stencil_operation: StencilOperation | str | None = None, stencil_id: primitives.Byte | None = None, stencil_write_mask: primitives.Byte | None = None, stencil_read_mask: primitives.Byte | None = None, render_queue: primitives.Int | None = None, shader: str | IAssetProvider[Shader] | None = None, texture: str | IAssetProvider[ITexture2D] | None = None, texture_scale: primitives.Float2 | None = None, texture_offset: primitives.Float2 | None = None, tint: primitives.ColorX | None = None, overlay: primitives.Bool | None = None, overlay_tint: primitives.ColorX | None = None, alpha_cutoff: primitives.Float | None = None, alpha_clip: primitives.Bool | None = None, texture_mode: UnlitTextureMode | str | None = None, mask_texture: str | IAssetProvider[ITexture2D] | None = None, mask_scale: primitives.Float2 | None = None, mask_offset: primitives.Float2 | None = None, mask_mode: MaskTextureMode | str | None = None, blend_mode: BlendMode | str | None = None, sidedness: Sidedness | str | None = None, zwrite: ZWrite | str | None = None, ztest: ZTest | str | None = None, offset_factor: primitives.Float | None = None, offset_units: primitives.Float | None = None, *, component: workers.Component | None = None) -> None:
    ...
    @property
    def texture_mode(self) -> UnlitTextureMode | None:
        """The TextureMode enum value."""
        member = self.get_member("TextureMode")
        if isinstance(member, members.FieldEnum) and member.value is not None:
            return UnlitTextureMode(member.value)
        return None

    @texture_mode.setter
    def texture_mode(self, value: UnlitTextureMode | str) -> None:
        """Set the TextureMode enum value."""
        member = self.get_member("TextureMode")
        if isinstance(member, members.FieldEnum):
            member.value = str(value)
        else:
