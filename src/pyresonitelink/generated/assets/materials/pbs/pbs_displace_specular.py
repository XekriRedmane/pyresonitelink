"""Generated component: PBS_DisplaceSpecular."""
...
class PBS_DisplaceSpecular(GeneratedComponent, IPBS_Specular, ICullingMaterial, ICustomInspector, IWorldEventReceiver):
    """The PBS_DisplaceSpecular component can displace the vertices of a mesh in the direction of the vertex's normal via the VertexDisplaceMap settings and the WorldSpaceVertexOffsetMap.
