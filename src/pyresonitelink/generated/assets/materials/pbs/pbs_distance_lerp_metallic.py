...
class PBS_DistanceLerpMetallic(GeneratedComponent, ICullingMaterial, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    """Wrapper for [FrooxEngine]FrooxEngine.PBS_DistanceLerpMetallic.
