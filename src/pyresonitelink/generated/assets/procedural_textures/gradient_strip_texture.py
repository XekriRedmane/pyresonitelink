...
class GradientStripTexture(GeneratedComponent, ITexture2DProvider, ICustomInspector, IWorldEventReceiver):
    ...
    def __init__(self, high_priority_integration: bool | None = None, anisotropic_level: np.int32 | None = None, mipmap_bias: np.float32 | None = None, size: primitives.Int2 | None = None, mipmaps: bool | None = None, exp: np.float32 | None = None, *, component: workers.Component | None = None) -> None:
