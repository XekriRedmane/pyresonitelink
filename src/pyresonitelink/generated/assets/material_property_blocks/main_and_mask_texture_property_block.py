...
class MainAndMaskTexturePropertyBlock(GeneratedComponent, IAssetProvider, ICustomInspector, IWorldEventReceiver):
    ...
    def __init__(self, high_priority_integration: primitives.Bool | None = None, texture: str | IAssetProvider[ITexture2D] | None = None, mask_texture: str | IAssetProvider[ITexture2D] | None = None, *, component: workers.Component | None = None) -> None:
