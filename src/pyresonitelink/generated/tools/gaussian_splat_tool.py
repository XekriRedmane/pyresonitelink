...
class GaussianSplatTool(GeneratedComponent, ITool, IMaterialApplyPolicy, ITouchable, IItemMetadataSource, IWorldEventReceiver):
    ...
    def __init__(self, tip_reference: str | Slot | None = None, block_grip_equip: bool | None = None, block_remote_equip: bool | None = None, equip_name: str | None = None, override_active_tool: str | InteractionHandler | None = None, grip_poses_generated: bool | None = None, box_selection_template: str | BoxInterface | None = None, sphere_selection_template: str | SphereInterface | None = None, cylinder_selection_template: str | CylinderInterface | None = None, active_box: str | BoxInterface | None = None, active_sphere: str | SphereInterface | None = None, active_cylinder: str | CylinderInterface | None = None, *, component: workers.Component | None = None) -> None:
