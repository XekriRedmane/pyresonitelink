"""Generated component: ComponentCloneTool."""
...
class ComponentCloneTool(GeneratedComponent, ITool, IMaterialApplyPolicy, ITouchable, IItemMetadataSource, IWorldEventReceiver):
    ...
    def __init__(self, tip_reference: str | Slot | None = None, block_grip_equip: primitives.Bool | None = None, block_remote_equip: primitives.Bool | None = None, equip_name: primitives.String | None = None, override_active_tool: str | InteractionHandler | None = None, grip_poses_generated: primitives.Bool | None = None, apply_to_object_root: primitives.Bool | None = None, ensure_single_instance: primitives.Bool | None = None, allow_pickup: primitives.Bool | None = None, label: str | TextRenderer | None = None, template_root: str | Slot | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            ensure_single_instance: Initial value for EnsureSingleInstance.
            allow_pickup: Initial value for AllowPickup.
            label: Initial value for _label.
            template_root: Initial value for _templateRoot.
        ...
        if ensure_single_instance is not None:
            self.ensure_single_instance = ensure_single_instance
    ...
    def ensure_single_instance(self, value: primitives.Bool) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "EnsureSingleInstance", fields.FieldBool(value=value)
            )
    ...
    def allow_pickup(self, value: primitives.Bool) -> None:
        ...
        if member is not None:
            ...
            self.set_member(
                "AllowPickup", fields.FieldBool(value=value)
            )
    ...
    def template_root(self, target: str | Slot | None) -> None:
        """Set the _templateRoot reference by target ID or Slot instance."""
        target_id: str | None = target.id if isinstance(target, Slot) else target  # type: ignore[assignment]
        member = self.get_member("_templateRoot")
        if isinstance(member, members.Reference):
            member.targetId = target_id
