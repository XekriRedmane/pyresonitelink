"""Generated component: SpotLightTool."""
...
class SpotLightTool(GeneratedComponent, ITool, IMaterialApplyPolicy, ITouchable, IItemMetadataSource, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.SpotLightTool"

    def __init__(self, tip_reference: str | Slot | None = None, block_grip_equip: bool | None = None, block_remote_equip: bool | None = None, equip_name: str | None = None, override_active_tool: str | InteractionHandler | None = None, grip_poses_generated: bool | None = None, material: str | PBS_Metallic | None = None, light: str | Light | None = None, *, component: workers.Component | None = None) -> None:
    ...
    def material(self, target: str | PBS_Metallic | None) -> None:
        """Set the Material reference by target ID or PBS_Metallic instance."""
