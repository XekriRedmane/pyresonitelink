"""Generated component: CharacterColliderSetterTool."""
...
class CharacterColliderSetterTool(GeneratedComponent, ITool, IMaterialApplyPolicy, ITouchable, IItemMetadataSource, IWorldEventReceiver):
    ...
    COMPONENT_TYPE = "[FrooxEngine]FrooxEngine.CharacterColliderSetterTool"

    def __init__(self, tip_reference: str | Slot | None = None, block_grip_equip: bool | None = None, block_remote_equip: bool | None = None, equip_name: str | None = None, override_active_tool: str | InteractionHandler | None = None, grip_poses_generated: bool | None = None, apply_to_object_root: bool | None = None, mark_grippable: bool | None = None, *, component: workers.Component | None = None) -> None:
        ...
        Args:
            ...
            mark_grippable: Initial value for MarkGrippable.
        ...
        if mark_grippable is not None:
            self.mark_grippable = mark_grippable
    ...
    @property
    def mark_grippable(self) -> bool | None:
    ...
    @mark_grippable.setter
    def mark_grippable(self, value: bool) -> None:
        """Set the MarkGrippable field value."""
        member = self.get_member("MarkGrippable")
        if member is not None:
            member.value = value  # type: ignore[attr-defined]
        else:
            self.set_member(
                "MarkGrippable", fields.FieldBool(value=value)
            )
